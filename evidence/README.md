...
六个问题均已完成证据采集、分析和个人审阅；报告见根目录的 [分析报告.md](../分析报告.md)。第一问已完整重跑并通过计数核对，第二至第六问均保存固定快照下的脚本、统计和案例证据。研究仓库在各轮分析前后均未被修改。
...
六个问题均已完成。第二至第六问的证据索引依次见 [q2/README.md](q2/README.md)、[q3/README.md](q3/README.md)、[q4/README.md](q4/README.md)、[q5/README.md](q5/README.md)和[q6/README.md](q6/README.md)。个人判断与统计结论在报告中分开标注。
